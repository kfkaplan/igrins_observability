...
ds9.set(
    'regions group FOV property move no')  #Make FOV unmoveable, might change this later if this causes issues with folks
ds9.set(
    'regions group FOV moveback')  #move regions such as the FOV, slit, compass, etc. to the back so the user can select guide star points
